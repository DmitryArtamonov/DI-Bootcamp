...
class Game():
    ...
    def get_game_result(self):
        if self.computer_item == self.user_item:
            return 0
        elif self.turn_options[self.user_item] - self.turn_options[self.computer_item] in [1, -2]:
            return 1
        else:
            return -1
    ...
    def play(self):
        ...
        print(f'You selected {self.turn_names[self.user_item]}.'
